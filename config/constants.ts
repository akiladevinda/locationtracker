...
/** Auto-upload pending GPS points to Supabase while tracking / app process is alive. */
...
export const FOREGROUND_SERVICE_NOTIFICATION = {
  // Android requires a persistent notification for background GPS. Keep it short/quiet.
